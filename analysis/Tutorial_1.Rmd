...
# Sample clustering (based on gene expression data)
...
## Calculate, cluster, and merge based on eigengenes
...
# Study relationships between triats and modules using eigengene networks
...
In this example, we will identify the key genes in the brown module. 
```{r}
...
## Annotate the genes in the brown module
...
# Integrate the network analysis with functional enrichment/GO analysis
...
Note: Since the function GoEnrichmentAnalysis is defunction, per the author's suggestion, we are using the function enrichmentAnalysis from the package "AnRichment" from the same authors. For more information about this package, https://labs.genetics.ucla.edu/horvath/htdocs/CoexpressionNetwork/GeneAnnotation/Tutorials/anRichment-Tutorial1.pdf. 
```{r}
